  ...
  return (
    <div className="relative h-96 ml-10 mr-10 mt-10 rounded-tr-3xl rounded-bl-3xl bg-gray-900">
      ...
      <div className="relative flex-col z-10 flex items-center justify-center h-full">
        ...
        <h3 className=' flex flex-row gap-3 font-f1regular text-white text-sm p-3 mt-1 bg-white bg-opacity-25 rounded-full'>26 - 28 JUL <h1>|</h1> <h6 className='font-f1regular text-white text-sm hover:text-red-600'><a href='https://www.formula1.com/en/racing/2024/belgium' className='underline underline-offset-4'>See Race Stats</a></h6>
        </h3>
